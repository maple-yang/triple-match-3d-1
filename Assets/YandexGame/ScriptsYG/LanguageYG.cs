...
namespace YG
{
    public class LanguageYG : MonoBehaviour
    {
        ...
        public TextMeshProUGUI textMeshProUGUIComponent;
        ...
        private void Awake()
        {
            ...
            else if (textMeshProUGUIComponent)
                baseFontSize = (int)textMeshProUGUIComponent.fontSize;
        }
        ...
        private void OnEnable()
        {
            ...
            var language = gameDataModel == null || string.IsNullOrEmpty(gameDataModel.Language)
        ...
        void AssignTranslate(string translation)
        {
            if (textUIComponent)
                ...
                textMeshProUGUIComponent.text = translation;
        }
        ...
        void FontSizeCorrect(int[] fontSizeArray)
        {
            if (textUIComponent)
                ...
                textMeshProUGUIComponent.fontSize = baseFontSize;
            ...
            if (fontSizeArray.Length != 0 && fontSizeArray.Length >= fontNumber - 1)
            {
                if (textUIComponent)
                    ...
                    textMeshProUGUIComponent.fontSize += fontSizeArray[fontNumber];
            }
        }
        ...
        string TranslateGoogle(string translationTo = "en")
        {
            ...
            if (!componentTextField)
                ...
                text = textMeshProUGUIComponent.text;
            else
            {
